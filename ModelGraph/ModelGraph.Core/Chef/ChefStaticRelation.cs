...
namespace ModelGraph.Core
{
    public partial class Chef
    {
        ...
        //internal RelationOf<TableX, RelationXO> Store_ChildRelation { get; private set; }
        //internal RelationOf<TableX, RelationXO> Store_ParentRelation { get; private set; }
        ...
        private void InitializeRelations()
        {
            ...
            //Store_ChildRelation = new RelationOf<TableX, RelationXO>(RelationStore, IdKey.TableX_ChildRelationX, Pairing.OneToMany, 25, 25, true);
            //AddIntegrityCheck(Store_ChildRelation, TableXStore, RelationXStore);

            //Store_ParentRelation = new RelationOf<TableX, RelationXO>(RelationStore, IdKey.TableX_ParentRelationX, Pairing.OneToMany, 25, 25, true);
            //AddIntegrityCheck(Store_ParentRelation, TableXStore, RelationXStore);
