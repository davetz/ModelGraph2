...
namespace ModelGraph.Core
{
     ...
     */
        ...
        //=========================================
        ViewNameProperty = 0x401 | IsInternal,
        ViewSummaryProperty = 0x402 | IsInternal,
        IncludeItemIdentityIndexProperty = 0x403 | IsCovert,

        //=========================================
        EnumNameProperty = 0x411 | IsInternal,
        EnumSummaryProperty = 0x412 | IsInternal,
        EnumTextProperty = 0x413 | IsInternal,
        EnumValueProperty = 0x414 | IsInternal,

        //=========================================
        TableNameProperty = 0x421 | IsInternal,
        TableSummaryProperty = 0x422 | IsInternal,

        //=========================================
        ColumnNameProperty = 0x431 | IsInternal,
        ColumnSummaryProperty = 0x432 | IsInternal,
        ColumnValueTypeProperty = 0x433 | IsInternal,
        ColumnIsChoiceProperty = 0x436 | IsInternal,

        //=========================================
        RelationNameProperty = 0x441 | IsInternal,
        RelationSummaryProperty = 0x442 | IsInternal,
        RelationPairingProperty = 0x443 | IsInternal,
        RelationIsRequiredProperty = 0x444 | IsInternal,
        RelationIsReferenceProperty = 0x445 | IsInternal,

        //=========================================
        GraphNameProperty = 0x451 | IsInternal,
        GraphSummaryProperty = 0x452 | IsInternal,
        GraphTerminalLengthProperty = 0x453 | IsInternal,
        GraphTerminalSpacingProperty = 0x454 | IsInternal,
        GraphTerminalStretchProperty = 0x455 | IsInternal,
        GraphSymbolSizeProperty = 0x456 | IsInternal,

        //=========================================
        QueryXSelectProperty = 0x460 | CanMultiline | IsInternal,
        QueryXWhereProperty = 0x461 | CanMultiline | IsInternal,

        QueryXConnect1Property = 0x462 | IsInternal,
        QueryXConnect2Property = 0x463 | IsInternal,

        QueryXRelationProperty = 0x466 | IsInternal,
        QueryXIsReversedProperty = 0x467 | IsInternal,
        QueryXIsImmediateProperty = 0x468 | IsInternal,
        QueryXIsPersistentProperty = 0x469 | IsInternal,
        QueryXIsBreakPointProperty = 0x46A | IsInternal,
        QueryXExclusiveKeyProperty = 0x46B | IsInternal,
        QueryXAllowSelfLoopProperty = 0x46C | IsInternal,
        QueryXIsPathReversedProperty = 0x46D | IsInternal,
        QueryXIsFullTableReadProperty = 0x46E | IsInternal,
        QueryXFacet1Property = 0x46F | IsInternal,
        QueryXFacet2Property = 0x470 | IsInternal,
        ValueXWhereProperty = 0x471 | CanMultiline | IsInternal,
        ValueXSelectProperty = 0x472 | CanMultiline | IsInternal,
        ValueXIsReversedProperty = 0x473 | IsInternal,
        ValueXValueTypeProperty = 0x474 | IsReadOnly,
        QueryXLineStyleProperty = 0x475 | IsInternal,
        QueryXDashStyleProperty = 0x476 | IsInternal,
        QueryXLineColorProperty = 0x477 | IsInternal,

        //=========================================
        SymbolXNameProperty = 0x481 | IsInternal,
        SymbolXAttatchProperty = 0x486 | IsInternal,
        ...
        //=========================================
        ComputeXNameProperty = 0x4B1 | IsInternal,
        ComputeXSummaryProperty = 0x4B2 | IsInternal,
        ComputeXCompuTypeProperty = 0x4B3 | IsInternal,
        ComputeXWhereProperty = 0x4B4 | IsInternal,
        ComputeXSelectProperty = 0x4B5 | IsInternal,
        ComputeXSeparatorProperty = 0x4B6 | IsInternal,
        ComputeXValueTypeProperty = 0x4B7 | IsReadOnly,
        ComputeXNumericSetProperty = 0x4B8 | IsInternal,
        ComputeXResultsProperty = 0x4B9 | IsInternal,
        ComputeXSortingProperty = 0x4BA | IsInternal,
        ComputeXTakeSetProperty = 0x4BB | IsInternal,
        ComputeXTakeLimitProperty = 0x4BC | IsInternal,
        #endregion
