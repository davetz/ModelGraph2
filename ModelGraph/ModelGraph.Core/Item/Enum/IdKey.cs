...
namespace ModelGraph.Core
{
     ...
     */
        ...
        //=====================================================================
        EnumXListMetaModel = 0x642,
        TableXListMetaModel = 0x643,
        GraphXListMetaModel = 0x644,
        SymbolXListMetaModel = 0x645,
        MetaGraphParmListModel = 0x646,

        TableXListModel = 0x647,
        GraphXListModel = 0x648,
        //=====================================================================
        PairXMetaModel = 0x652,
        EnumXMetaModel = 0x653,
        TableXMetaModel = 0x654,
        GraphXMetaModel = 0x655,
        SymbolXMetaModel = 0x656,
        ColumnXMetaModel = 0x657,
        ComputeXMetaModel = 0x658,
        SymbolEditorModel = 0x659,
        //=====================================================================
        ColumnXListMetaModel = 0x661,
        ChildRelationListMetaModel = 0x662,
        ParentRelatationListMetaModel = 0x663,
        EnumXPairListMetaModel = 0x664,
        EnumXColumnListMetaModel = 0x665,
        ComputeXListMetaModel = 0x666,
        EnumXRelatedColumnMetaModel = 0x667,
        //=====================================================================
